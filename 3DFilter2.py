...
filters_config = {
    'anonymous':
        [{'path': "filters/Layer22.png",
          'anno_path': "filters/modi22.csv",
...
def getLandmarks(img):
    ...
    print('a: ',len(selected_keypoint_indices))

    height, width = img.shape[:-1]

    with mp_face_mesh.FaceMesh(max_num_faces=
                               5, static_image_mode=True, min_detection_confidence=0.3) as face_mesh:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        points2_X = getLandmarks(cv2.cvtColor(frame, cv2.COLOR_BGR2RGB))
        ...
        for points2 in points2_X:
            ...
            cv2.putText(output, str(fps), (7, 70), font, 3, (100, 255, 0), 3, cv2.LINE_AA)
